...
var detailSchema = new Schema({
	...
	tk_co:{type:String,uppercase:true},
	...
	tien_phi:{type:Number,default:0,required:true},
	tien_phi_nt:{type:Number,default:0,required:true},
...
var ctcpmhSchema = new Schema({
	ma_cp:{type:String,uppercase:true,required:true},
	tien_cp_nt:{type:Number,default:0},
	tien_cp:{type:Number,default:0},
	line:{type:Number,default:0}
});

var pn1Schema = new Schema({
	id_app:{type:String,required:true},
	ma_dvcs:{type:String,required:true},
	ma_ct:{type:String,default:'pn1',required:true,uppercase:true},
	...
	ma_kho:{type:String,uppercase:true,required:true,default:''},
...
pn1Schema.index({id_app:1,ma_dvcs:1,so_ct:1,ngay_ct:1});
module.exports = mongoose.model('pn1',pn1Schema);