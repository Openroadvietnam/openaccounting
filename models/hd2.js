...
var detailSchema = new Schema({
	...
	tk_gv:{type:String,required:true,uppercase:true},
...
var hd2Schema = new Schema({
	id_app:{type:String,required:true},
	ma_dvcs:{type:String,required:true},
	ma_ct:{type:String,default:'hd2',required:true,uppercase:true},
...
hd2Schema.index({id_app:1,ma_dvcs:1,so_ct:1,ngay_ct:1});
module.exports = mongoose.model('hd2',hd2Schema);