...
var detailSchema = new Schema({
	...
	tk_gv:{type:String,uppercase:true,required:"Lỗi: Tài khoản giá vốn chưa được nhập"},
	...
	tk_tl:{type:String,uppercase:true,required:"Lỗi: Tài khoản trả lại chưa được nhập"},
...
var hd3Schema = new Schema({
	id_app:{type:String,required:true},
	ma_dvcs:{type:String,required:true},
	ma_ct:{type:String,default:'hd3',required:true,uppercase:true},
...
hd3Schema.index({id_app:1,ma_dvcs:1,so_ct:1,ngay_ct:1});
module.exports = mongoose.model('hd3',hd3Schema);