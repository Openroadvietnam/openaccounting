...
var detailSchema = new Schema({
	...
	ma_kho_x:{type:String,required:true,uppercase:true},
	ma_kho_n:{type:String,required:true,uppercase:true},
	...
	px_gia_dd:{type:Boolean,default:true},
...
detailSchema.validate ={
	...
	ma_kho_x:validVt.existsKho,
	ma_kho_n:validVt.existsKho,
	ma_dvt:validator.existsDvt
}
var pxcSchema = new Schema({
	id_app:{type:String,required:true},
	ma_dvcs:{type:String,required:true},
	ma_ct:{type:String,default:'pxc',required:true,uppercase:true},
...
pxcSchema.index({id_app:1,ma_dvcs:1,so_ct:1,ngay_ct:1});
module.exports = mongoose.model('pxc',pxcSchema);