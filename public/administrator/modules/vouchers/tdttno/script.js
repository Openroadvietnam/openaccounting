angular.module('tdttnoModule',[])
	...
	return {
		...
		templateUrl:'modules/vouchers/tdttno/templates/table.html',
		controller:function($scope,$modal,dmkh,dmvat,$timeout,$http){
			...
			$scope.getInvoice = function(){
				...
				var url ="/api/" + id_app + "/getinvoice2receive?ma_kh=" + $scope.ngMasterData.ma_kh;
			...
			$scope.openDetail = function (size,template) {
				var modalInstance = $modal.open({
				  templateUrl: 'modules/vouchers/tdttno/templates/edit.html',
