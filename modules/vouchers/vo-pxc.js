...
module.exports = function(router){
	...
	this.contr.post = function(obj){
		...
		obj.details.forEach(function(d){
			...
			detail.nxt = 2;
			detail.he_so_qd =1;
			detail.ma_kho = detail.ma_kho_x;
			detail.sl_xuat_qd = detail.sl_xuat * detail.he_so_qd;
			details_kho.push(detail);
		});
		//post sokho nhap
		obj.details.forEach(function(d){
			var detail = d.toObject();
			detail.nxt = 1;
			detail.he_so_qd =1;
			detail.pn_gia_tb = true;
			detail.ma_kho = detail.ma_kho_n;
			detail.tk_vt = detail.tk_du;
		...
		var postsokho = new PostBook(obj,details_kho,Sokho);
		postsokho.run();
		//post socai detail
